...
class CplProvider {
  ...
  static final CplProvider _instance = CplProvider._internal();
  factory CplProvider() => _instance;
  CplProvider._internal();
  ...
  Future<void> init() async {
    ...
    final connMess = MqttConnectMessage()
        .withClientIdentifier('Mqtt_MyClientUnique14')
    ...
    //subscriber
    const topic = '1/cpl'; // Not a wildcard topic
